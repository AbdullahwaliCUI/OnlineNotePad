      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <span className="text-2xl font-bold">NotepadX</span>
              </div>
              <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
                Transform your productivity with the most advanced note-taking app. 
                Voice input, beautiful themes, and seamless collaboration - all in one place.
              </p>
        ...
        >
          <div className="mb-4 md:mb-0">
            <p>&copy; {new Date().getFullYear()} NotepadX. All rights reserved.</p>
          </div>
